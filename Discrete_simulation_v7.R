...
for (j in 1:1000){
  ...
  write.table(site_dat_sum, file = "SimulationDecision_CV3.0.csv", append = TRUE, row.names = FALSE, 
...
dat <- read_csv("SimulationDecision_CV3.0.csv")
...
write.csv(dat_sum1, "MatchSummary_byRatio_CV3.0.csv", row.names = T)
...
write.csv(dat_sum1, "MatchSummary_byDUcount_CV3.0.csv", row.names = T)
